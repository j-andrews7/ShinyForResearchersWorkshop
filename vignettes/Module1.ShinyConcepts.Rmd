...
It allows development of apps that can process, analyze, and visualize data in real time, without needing to know any HTML, 
CSS, or JavaScript, although these can be used for more advanced customization.
...
Many additional packages are available to extend Shiny's capabilities, 
