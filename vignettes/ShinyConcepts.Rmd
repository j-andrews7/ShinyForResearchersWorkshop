...
If you found the previous exercise too easy, try adding a new inputs that allow the user to change the x and y-axis labels of the scatterplot.
...
- An Introduction Reactivity: We learned about the concept of reactivity, which is the core of Shiny's interactivity. 
